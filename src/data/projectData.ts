...
const projectData = [
  ...
  },
  {
    ...
    description:
      "Dictionary Web App using HTML, CSS, and JavaScript, seamlessly integrating the Free Dictionary API to provide users with quick and reliable word definitions.",
    image: DictionaryApp,
  ...
  },
  {
    ...
    description:
      "IP Address Tracker is a web application built with React and Tailwind CSS that allows users to track the location of an IP address using the IP Geolocation API.",
  ...
  },
  {
    ...
    title: "Clock App",
    description:
      "Clock App is a simple clock application built with React and Tailwind CSS.",
    image: ClockApp,
    url: "https://example.com",
